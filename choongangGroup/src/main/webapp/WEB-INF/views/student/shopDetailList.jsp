...
<style type="text/css">
	...
	.cateName span {margin-right: 40px; }
	.bookName span {margin-right: 40px; }
	.publisher span {text-align:center; margin-right: 58px; }
	.bookPrice span {text-align:center; margin-right: 24px; }
	.bookCount span {margin-right: 24px; }
</style>
               ...
               <div><span class="text-white ms-2 font09">${email}</span></div>
				...
				<div class="row m-5">
                    ...
                    <div class="col-9 rounded-top text-white overflow-auto pt-2 fw-bold" style="background-color: rgb(39, 40, 70); height: 40px; margin-left: 150px;"> 
                        <i class="bi bi-bookmark-fill me-2"></i>교재 구매<i class="bi bi-chevron-right"></i>교재 목록<i class="bi bi-chevron-right"></i>${books.bookName }
                    </div>
							...
							<section id="container">
								<form action="" role="form" method="post" autocomplete="off">
									<input type="hidden" id="userId" name="userId"
										value="${userId }"> <input type="hidden" id="bookId"
										name="bookId" value="${books.bookId}" />
								</form>
								<div>
									<div class="bookImg" style="float: left;margin-left: 170px ; margin-right: 70px ;">
										<img style="width: 500px; height: 300px;  object-fit: contain;"
											src="${books.bookImg}">
									</div>
									<p></p>
									<div class="books" style="float: inherit; margin-bottom: 50px;">
										<p class="cateName">
											<span>수업 명</span><input type="hidden" value="${books.cateName}"
												style="margin-bottom: 200px;">${books.cateName}</input>
										</p>
										<p class="bookName">
											<span>교재 명</span><input type="hidden" value="${books.bookName}" style="">${books.bookName}
										</p>

										<p class="publisher">
											<span>저  자</span>${books.publisher}
										</p>

										<p class="bookPrice">
											<span>교재 가격</span>
											<fmt:formatNumber value="${books.bookPrice}"
												pattern="###,###,###" />
											원
										</p>
										...
										<c:if test="${books.bookStock != 0}">
											<p class="bookCount">
												...
												<input type="number" class="numBox" min="1"
													max="${books.bookStock }" value="1" style="width: 50px;">
												<!-- <button type="button" class="minus">-</button> -->
											</p>
											<p class="addToCart">
												<button type="button" id="addCart" onclick="addCart_btn()"
													style="border: 0px; background: none;">
													<h4>
														<i class="bi bi-cart2"
															style="color: black; margin-right: 20px;"></i>
													</h4>
												</button>
											</p>
										</c:if>
										<div class="bookInfo" style="margin-top: 100px;">
											<hr>
