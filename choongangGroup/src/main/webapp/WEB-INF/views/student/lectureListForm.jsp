							...
							<table class="table table-striped mt-5">
								...
								<c:forEach var="lec" items="${list}">
									<tr>
										...
										<td>${lec.lecture.major }</td><td>${lec.lecture.unitScore }</td><td><i class="bi-file-earmark-pdf-fill" style="color: red"> </i><a href="fileDownload?lecId=${lec.lecture.id}">${lec.lecture.fileName }</a></td>
