...
<table border="1">
			...
			<input type="text" name="address"  required="required" value="${member.address }"></td></tr>
			<tr><th>성별</th><td>
			
			${member.gender }</td> 		
			<%-- <th>학적상태</th><td>
			
			${member.studStatus }</td> --%>    
			<th>E-Mail</th><td>
			...
			<input type="text" name="subphone" required="required"
			 value="${member.subphone }"></td></tr> 
			<tr><th>입금은행</th><td>
