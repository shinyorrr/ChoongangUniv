                ...
                <div class="row m-5">
                    ...
                    <div class="col-12 rounded-bottom overflow-auto bg-light p-3" style="min-height: 550px;"> 
                        ...
                        <!-- class="fw-bold border rounded-top " style="background-color:#EAEAEA; height: 45px;" -->
                       	<div class="fw-bold">
                       		<span style="line-height: 45px;">${year }학년도 ${semester }학기 개설강좌</span>
                       		
                    		<!-- 강의명으로 검색 -->
                       		<form action="applyForm" method="get" class="row row-cols-lg-auto g-3 float-end" >
	                       		  <span style="line-height: 45px;">강의명 :&nbsp;</span>
	                       		  
								  <div class="col-12">							    
								  	<div class="input-group">				     
								      <input type="text" name="lecName" class="form-control" placeholder="강의명으로 검색">
								    </div>
								  </div>
								 ...
								 <div class="col-12">	
									...
									<select class="form-select" name="select" onchange="submit(this.form)">
										<option label="강의 목록"/>
