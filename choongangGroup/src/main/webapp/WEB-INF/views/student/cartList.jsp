	...
	<section id="content">
		...
		<div id="container_box">
			<ul>
				<li>
					<div class="allCheck">
						<input type="checkbox" class="allCheck" name="allCheck"	id="allCheck" onclick="allChk()" /><label for="allCheck">모두
							선택</label>
					</div>
				...
				<c:forEach items="${cartList}" var="cartList">
					...
					<li>
						<div class="checkBox">
							<input type="checkbox" class="chBox" name="chBox" id="chBox"
						...
						<div class="bookInfo">
							<p>
								<input type="hidden" value="${cartList.userId }"> <input
									type="hidden" value="${cartList.cartNum }" id="cartNum"
									class="cartNum" name="cartNum"> <span>상품명 : </span>${cartList.bookName}<br />
								<span>개당 가격 : </span>
								<fmt:formatNumber pattern="###,###,###"
									value="${cartList.bookPrice}" />
								<br /> <span>구입 수량 : <%-- <input type="number" value="${cartList.cartStock}" id="cartStock" name="cartStock"> --%></span>${cartList.cartStock}<br />
								<span>최종 가격 : </span>
								<fmt:formatNumber pattern="###,###,###"
									value="${cartList.bookPrice * cartList.cartStock}" />
							</p>
							<div class="delete">
								<button type="button" class="delete_btn"
									onclick="selectDelete_btn()"<%--  data-cartNum="${cartList.cartNum}"  --%>>삭제</button>
							</div>
				...
				<form role="form" method="post" autocomplete="off">
					...
					<div class="inputArea">
						<label for="orderName">수령인</label> <input type="text"
							name="orderName" id="orderName" required="required" />
					</div>

					<div class="inputArea">
						<label for="Phone" style="width: auto;">수령인 연락처</label> <input
