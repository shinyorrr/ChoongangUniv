...
<script type="text/javascript">
	...
	function deleteMessage(){
		...
		$.ajax({
			url 	: "/manager/SendermessageDeleteOne",
		                       ...
		                       <div class="mb-3">
		                     	...
		                     	<div>
		                      	...
		                      	<div style="margin: 10px;">
		                      			...
		                      			<button id="beforeButton" type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">재전송</button>	
										<!-- Modal -->
										<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
										  <div class="modal-dialog">
										    <div class="modal-content">
										      <div class="modal-header">
										        <h1 class="modal-title fs-5" id="staticBackdropLabel">재전송</h1>
