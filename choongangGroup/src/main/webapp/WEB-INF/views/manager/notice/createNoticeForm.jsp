                    ...
                    <div class="col-12 rounded-bottom overflow-auto bg-light p-3" style="min-height: 550px;"> 
	                    ...
	                    <form action="<%=context%>/notice/noticeSave" method="post">
		                	<div style="margin: 10px;">
		                		...
		                		<input type="text" class="form-control" id="noticeTitle exampleFormControlInput1" name="noticeTitle" placeholder="제목을 입력하세요.">
		                	</div>
		                    <div style="margin: 10px;">
		                    	 <label for="exampleFormControlTextarea1" class="form-label">내용</label>
		                    	 <textarea class="form-control" rows="3" id="noticeContent exampleFormControlTextarea1" name="noticeContent" style="height: 300px;"></textarea>
		                    </div>
