...
|**이름**|**역할**|**개발 내용**|
|:---:|:---:|:---:|
|손신효|Back-end(학생)|수강신청 기간 설정/기간 외 검사<br>수강신청 중복 검사<br>신청가능 전체강의/장바구니 목록 조회/검색<br>최대 신청학점 검사<br>시간표 조회<br>장바구니 담기/삭제<br>과제 파일 업로드<br>사용자 정보 표시|
...
<p align="center"><img src="https://github.com/shinyorrr/ChoongangUniv/assets/113576529/c6363b5f-d4e6-448a-8950-52a356ad9ddd.png" width="750">
